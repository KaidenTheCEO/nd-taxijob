...
if not Locale then
    error("Locale module is not loaded")
end
...
local Translations = {
    ...
    info = {
        ...
        ['tip_received'] = 'You have been tipped for your safe driving',
    ...
    menu = {
        ...
        ['boss_menu'] = 'Boss Menu',
        ['do_taxi_npc'] = 'Do Taxi NPC', -- Translation for the "Do Taxi NPC" menu item
        ['toggle_meter'] = 'Toggle Meter', -- Translation for the "Toggle Meter" menu item
    }
}
